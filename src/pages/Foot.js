                ...
                <div className="footer">
                    <div className="top-footer">
                        ...
                        <div >
                            ...
                            <a href={gLink}>Privacy Policy</a><br />
                            <a href={gLink}>Youtube Channel Link </a><br />
                            <a href={gLink}>Blog Articles </a><br />
                            <a href={gLink}>Social Media</a>
                        </div>

                        <div >
                            <h2>Our Services</h2>
                            <a href={gLink}>Web Designing </a><br />
                            <a href={gLink}>Web Development </a><br />
                            <a href={gLink}>SEO services </a><br />
                            <a href={gLink}>Software Development </a><br />
                            <a href={gLink}>Mobile App Development </a><br />
                            <a href={gLink}>Graphic Designing</a>
                        </div>

                        <div>
                            <h2>Contact Us</h2>
                            <a href={gLink}><i className="fas fa-phone"></i> +(91) 99999 99999 </a><br />
                            <a href={gLink}><i className="fas fa-envelope"></i> inquiry@webdev.co.com </a><br />
                            <div className="embed-responsive embed-responsive-16by9">
                                <iframe className="embed" title='map'
